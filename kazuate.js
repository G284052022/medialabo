...
function hantei() {
  ...
  if(kaisu < 4){
    if(kaisu == 3 ){
        ...
        if(yoso == kotae){
            xdocument.getElementById("result").textContent= '正解です．おめでとう!';
            kaisu = 4;
        }else if(yoso < kotae){
            document.getElementById("result").textContent = 'まちがい．答えはもっと大きいですよ';
        }else{
            xdocument.getElementById("result").textContent = 'まちがい．答えはもっと小さいですよ';
        }
    }
  }else{
...
document.getElementById("sumbit").addEventListener("click",hantei);
